...
(function () {
	BX.Sale.PersonalOrderComponent.PersonalOrderDetail = {
		init: function (params) {
			var linkMoreOrderInformation = document.getElementsByClassName(
				"sale-order-detail-about-order-inner-container-name-read-more"
			)[0];
			var linkLessOrderInformation = document.getElementsByClassName(
				"sale-order-detail-about-order-inner-container-name-read-less"
			)[0];
			var clientInformation = document.getElementsByClassName(
				"sale-order-detail-about-order-inner-container-details"
			)[0];
			var listShipmentWrapper = document.getElementsByClassName(
				"sale-order-detail-payment-options-shipment"
			);
			var listPaymentWrapper = document.getElementsByClassName(
				"sale-order-detail-payment-options-methods"
			);
			var shipmentTrackingId = document.getElementsByClassName(
				"sale-order-detail-shipment-id"
			);

			if (shipmentTrackingId[0]) {
				Array.prototype.forEach.call(shipmentTrackingId, function (blockId) {
					var clipboard = blockId.parentNode.getElementsByClassName(
			...
			Array.prototype.forEach.call(listShipmentWrapper, function (shipmentWrapper) {
				var detailShipmentBlock = shipmentWrapper.getElementsByClassName(
					"sale-order-detail-payment-options-shipment-composition-map"
				)[0];
				var showInformation = shipmentWrapper.getElementsByClassName(
					"sale-order-detail-show-link"
				)[0];
				var hideInformation = shipmentWrapper.getElementsByClassName(
				...
				BX.bindDelegate(
					shipmentWrapper,
					"click",
					{ class: "sale-order-detail-show-link" },
					BX.proxy(function () {
				...
				BX.bindDelegate(
					shipmentWrapper,
					"click",
					{ class: "sale-order-detail-hide-link" },
					BX.proxy(function () {
			...
			Array.prototype.forEach.call(listPaymentWrapper, function (paymentWrapper) {
				var rowPayment = paymentWrapper.getElementsByClassName(
				...
				BX.bindDelegate(
					...
					BX.proxy(function (event) {
						...
						var btn = rowPayment.parentNode.getElementsByClassName(
							"sale-order-detail-payment-options-methods-button-container"
						)[0];
						var linkReturn = rowPayment.parentNode.getElementsByClassName(
