<?\Bitrix\Main\Localization\Loc::loadMessages(__FILE__);?>
			...
			<?if (!defined("INDEX_PAGE")):?></div><?endif;?>
		</div>
				...
				<div class="limiter">
					<div class="creator">
						<?if(!empty($TEMPLATE_FOOTER_VARIANT) && ($TEMPLATE_FOOTER_VARIANT == "6" || $TEMPLATE_FOOTER_VARIANT == "7")):?>
							<!-- <a href="https://dw24.su/"><img src="<?=SITE_TEMPLATE_PATH?>/images/dwC.svg" alt="Digital Web"></a> -->
						<?elseif(!empty($TEMPLATE_FOOTER_VARIANT) && ($TEMPLATE_FOOTER_VARIANT == "4" || $TEMPLATE_FOOTER_VARIANT == "5" || $TEMPLATE_FOOTER_VARIANT == "6")):?>
							<!-- <a href="https://dw24.su/"><img src="<?=SITE_TEMPLATE_PATH?>/images/dwW.svg" alt="Digital Web"></a> -->
						<?else:?>
							<!-- <a href="https://dw24.su/"><img src="<?=SITE_TEMPLATE_PATH?>/images/dw.svg" alt="Digital Web"></a> -->
						<?endif;?>
					</div>
					<div class="social">
						<?$APPLICATION->IncludeComponent(
	...
	<?if(!defined("DELUXE_IS_DISABLE_SETTINGS_VIEW")):?>
		<?$APPLICATION->IncludeComponent(
			"dresscode:settings",
			".default",
			array(
	...
	<?$APPLICATION->IncludeComponent(
		...
		array(
			"AREA_FILE_SHOW" => "sect",
			"AREA_FILE_SUFFIX" => "cookie_notice",
			"AREA_FILE_RECURSIVE" => "Y",
			"EDIT_TEMPLATE" => ""
		),
		false
	...
	<div class="loading-spinner">
		<img
			src="<?=SITE_TEMPLATE_PATH?>/images/spinner.svg"
