				...
				<?if(count($arResult["ITEMS"]) > 3):?>
					<div id="menuCatalogSection">
						<div class="menuSection">
							<a href="<?=SITE_DIR?>catalog/" class="catalogButton"><img src="<?=SITE_TEMPLATE_PATH?>/images/catalogButton.svg" alt=""><?=GetMessage("CATALOG_BUTTON_LABEL")?> <img src="<?=SITE_TEMPLATE_PATH?>/images/sectionMenuArrow.svg" alt="" class="sectionMenuArrow"></a>
							<div class="drop">
								<div class="limiter">
