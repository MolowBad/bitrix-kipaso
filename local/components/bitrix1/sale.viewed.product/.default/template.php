			...
			<div class="wrap">
				<ul class="slideBox productList">
					<?foreach($arResult["ITEMS"] as $arElement):?>
						<li>
							<div class="item product" data-price-code="<?=!empty($arParams["PRICE_CODE"]) ? implode("||", !empty($arParams["PRICE_CODE"])) : ""?>">
								<div class="tabloid">
									...
									<?if(isset($arElement["PROPERTIES"]["RATING"]["VALUE"])):?>
									    <div class="rating">
									      <i class="m" style="width:<?=(intval($arElement["PROPERTIES"]["RATING"]["VALUE"]) * 100 / 5)?>%"></i>
									      <i class="h"></i>
									    </div>
								    <?endif;?>
