...
$arTemplateParameters = array(
	...
	"REDEFINE_THEME" => array(
		"NAME" => GetMessage("REDEFINE_THEME"),
		"TYPE" => "CHECKBOX",
		"DEFAULT" => "N",
		"REFRESH" => "Y",
		"PARENT" => "VISUAL"
	...
	"TEMPLATE_THEME" => array(
		...
		"PARENT" => "VISUAL",
		"HIDDEN" => $arCurrentValues['REDEFINE_THEME'] !== 'Y' ? 'Y' : 'N',
	),
	"COLOR_THEME" => array(
	...
	"BASKET_POSITION" => array(
		...
		"DEFAULT" => "after",
		"PARENT" => "VISUAL",
		"HIDDEN" => $arCurrentValues['SHOW_BASKET'] !== 'Y' ? 'Y' : 'N',
	),
...
if (!isset($arCurrentValues['SHOW_COUPONS']) || $arCurrentValues['SHOW_COUPONS'] === 'Y')
{
	...
	$arTemplateParameters["SHOW_COUPONS_TOTAL"] = [
		"NAME" => GetMessage("SHOW_COUPONS_TOTAL"),
		"TYPE" => "CHECKBOX",
		"MULTIPLE" => "N",
		"DEFAULT" => "Y",
		"PARENT" => "VISUAL",
...
$arTemplateParameters["SHOW_QUICK_LOCATIONS"] = array(
	"NAME" => GetMessage("SHOW_QUICK_LOCATIONS"),
	"TYPE" => "CHECKBOX",
	"MULTIPLE" => "N",
	"DEFAULT" => "Y",
	"PARENT" => "VISUAL",
...
$arTemplateParameters["COUNT_QUICK_LOCATIONS"] = array(
	"NAME" => GetMessage("COUNT_QUICK_LOCATIONS"),
	"TYPE" => "STRING",
	"MULTIPLE" => "N",
	"DEFAULT" => "3",
	"PARENT" => "VISUAL",
	"HIDDEN" => $arCurrentValues['SHOW_QUICK_LOCATIONS'] !== 'Y' ? 'Y' : 'N'
);
...
if ($arCurrentValues['SHOW_PICKUP_MAP'] == 'Y')
{
	$arDelivery = array();
...
$arTemplateParameters["USE_MASKED"] = array(
...
if(isset($arCurrentValues["USE_MASKED"]) && $arCurrentValues["USE_MASKED"] === "Y"){
	$arTemplateParameters["MASKED_FORMAT"] = array(
		"PARENT" => "ADDITIONAL_SETTINGS",
