	...
	BX.Sale.PersonalOrderComponent.PersonalOrderList = {
		init: function (params) {
			...
			Array.prototype.forEach.call(rowWrapper, function (wrapper) {
				var shipmentTrackingId = wrapper.getElementsByClassName(
				...
				BX.bindDelegate(
					...
					BX.proxy(function (event) {
						var block = wrapper.getElementsByClassName(
							"sale-order-list-inner-row-body"
						)[0];
						var template = wrapper.getElementsByClassName(
							"sale-order-list-inner-row-template"
						)[0];
						var cancelPaymentLink = template.getElementsByClassName(
				...
				BX.bindDelegate(
					wrapper,
					"click",
					{ class: "sale-order-list-change-payment" },
					BX.proxy(function (event) {
						event.preventDefault();
