...
$MESS["SHOW_BASKET"] = "Показывать список товаров";
...
$MESS["SHOW_COUPONS_TOTAL"] = "Показывать поле ввода купонов в блоке заказа";
...
$MESS["REDEFINE_THEME"] = "Переопределить цвет темы";
$MESS["THEME_BLUE"] = "Синяя (тема по умолчанию)";
$MESS["THEME_GREEN"] = "Зеленая";
$MESS["THEME_RED"] = "Красная";
$MESS["THEME_YELLOW"] = "Желтая";
$MESS["COLOR_THEME"] = "Код цвета для переопределения темы";
$MESS["TEMPLATE_THEME"] = "Цветовая тема";
$MESS["THEME_SITE"] = "Брать тему из настроек сайта (для решения deluxe)";
...
$MESS["SHOW_QUICK_LOCATIONS"] = "Отображать избранные местоположения";
$MESS["COUNT_QUICK_LOCATIONS"] = "Количество избранных местоположений для отображения";
?>