...
(function () {
	...
	BX.Sale.OrderAjaxComponent.Maps = {
		...
		showNearestPickups: function (successCb, failCb) {
			...
			var provider =
				this.pickUpOptions.secureGeoLocation &&
				BX.browser.IsChrome() &&
				!this.context.isHttps
					? "yandex"
					: "auto";
			...
			this.propsMap.events.add(
				...
				BX.delegate(function (e) {
					...
					if (this.propsMap.geoObjects.getLength() === 0) {
						...
						this.propsMap.geoObjects
							.get(0)
							.geometry.setCoordinates([coordinates[0], coordinates[1]]);
					}
				}, this)
			);
		},
