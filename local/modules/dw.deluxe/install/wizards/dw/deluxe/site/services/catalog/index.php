...
$curSiteSubscribe = $catalogSubscribe === 'Y' ? ['use' => 'Y', 'del_after' => '100'] : ['del_after' => '100'];
...
if (!in_array($catalogView, ['bar', 'list', 'price_list'])) {
	$catalogView = 'list';
}
...
$productReserveCondition = in_array($productReserveCondition, ['O', 'P', 'D', 'S']) ? $productReserveCondition : 'P';
