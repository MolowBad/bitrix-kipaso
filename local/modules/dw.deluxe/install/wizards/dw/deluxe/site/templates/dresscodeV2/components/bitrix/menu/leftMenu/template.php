											...
											<li>
												<div class="item product sku" id="<?=$this->GetEditAreaId($arElement["ID"]);?>" data-product-id="<?=!empty($arElement["~ID"]) ? $arElement["~ID"] : $arElement["ID"]?>" data-iblock-id="<?=$arElement["SKU_INFO"]["IBLOCK_ID"]?>" data-prop-id="<?=$arElement["SKU_INFO"]["SKU_PROPERTY_ID"]?>" data-product-width="180" data-product-height="240">
													<div class="tabloid">
														...
														<div class="optional">
															<div class="row">
																<a href="#" class="quickBuy label" data-id="<?=$arElement["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/getProductQuickBuyForm.png" alt="" class="icon"><?=GetMessage("QUICK_BUY_LABEL")?></a>
															...
															<div class="row">
																...
																<?if($arElement["CATALOG_QUANTITY"] > 0):?>
																	<a class="inStock label changeAvailable"><img src="<?=SITE_TEMPLATE_PATH?>/images/inStock.svg" alt="" class="icon"><?=GetMessage("AVAILABLE")?></a>
																<?else:?>
