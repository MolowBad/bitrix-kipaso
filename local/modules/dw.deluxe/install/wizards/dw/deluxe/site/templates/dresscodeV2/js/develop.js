		...
		$("<div />", {
			...
			.append(
				$("<span />", {
					...
					.html(" screen w: " + window.innerWidth + " px")
					.css({
						"margin-top": "12px",
						"padding-left": "4px",
						color: "#fff",
			...
			.append(
				$("<span />", {
					...
					.html(" screen h: " + window.innerHeight + " px")
					.css({
						"padding-left": "4px",
						color: "#fff",
						display: "block",
...
var re_create_dw_tools = function () {
	...
	$dw_develop_tools_w.html(" screen w: " + window.innerWidth + " px");
	$dw_develop_tools_h.html(" screen h: " + window.innerHeight + " px");
};
