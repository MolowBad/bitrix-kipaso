			...
			<div class="appFastViewColumnContainer">
				...
				<div class="appFastViewInformationColumn">
					...
					<div class="secondTool">
						...
						<?endif;?>
						<div class="row">
							<a href="#" class="quickBuy label changeID<?if(empty($arResult["PRICE"]) || $arResult["CATALOG_AVAILABLE"] != "Y"):?> disabled<?endif;?>"data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/quickBuy.svg" alt="<?=GetMessage("FAST_VIEW_QUICK_BUY_LABEL")?>" class="icon"><?=GetMessage("FAST_VIEW_QUICK_BUY_LABEL")?></a>
						</div>
						<div class="row">
