	...
	<div class="mainToolContainer">
		...
		<div class="mobileButtonsContainer columnRowWrap">
			...
			<div class="mobileFastBackContainer row columnRow">
				<a href="#" class="quickBuy label changeID<?if(empty($arResult["PRICE"]) || $arResult["CATALOG_AVAILABLE"] != "Y"):?> disabled<?endif;?>" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/quickBuy.svg" alt="<?=GetMessage("QUICK_BUY_LABEL")?>" class="icon"><?=GetMessage("QUICK_BUY_LABEL")?></a>
			</div>
		</div>
	</div>
</div>
