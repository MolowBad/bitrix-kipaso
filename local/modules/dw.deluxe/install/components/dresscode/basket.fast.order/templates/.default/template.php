		...
		<div class="fast-basket-container">
			...
			<form action="#" name="fast-basket-form" method="get" class="fast-basket-container__form" id="bind__fast-basket-form">
				...
				<div class="basket-container-form__field">
					...
					<label for="container-form__personal" class="container-form__label">
						<span>
							<?=GetMessage("FAST_BASKET_PERSONAL_INFO_TEXT")?>
							<a href="#" class="userAgreement pilink">
								<?=GetMessage("FAST_BASKET_PERSONAL_INFO_ACTION")?>
							</a>*
						</span>
					</label>
				</div>
				<div class="basket-container-form__field">
					...
					<a href="#" class="container-form-field__submit btn-simple" id="bind__fast-basket-submit"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.svg" class="form-field__image" alt="<?=GetMessage("FAST_BASKET_SUBMIT")?>" title="<?=GetMessage("FAST_BASKET_SUBMIT")?>"><?=GetMessage("FAST_BASKET_SUBMIT")?></a>
				</div>
			</form>
