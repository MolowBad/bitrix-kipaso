<?
	...
	if(!empty($arResult["CURRENT_SETTINGS"]["TEMPLATE_AGREEMENT_ID"])){
		$actualAgreementId = $arResult["CURRENT_SETTINGS"]["TEMPLATE_AGREEMENT_ID"];
	}

	else{
		$actualAgreementId = key($arResult["AGREEMENTS"]);
	}
?>
