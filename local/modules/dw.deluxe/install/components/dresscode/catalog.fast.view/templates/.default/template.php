			...
			<div class="appFastViewColumnContainer">
				...
				<div class="appFastViewInformationColumn">
					...
					<?if(!empty($arResult["PRICE"])):?>
						...
						<?endif;?>
						<a href="#" class="addCart<?if($arResult["CATALOG_AVAILABLE"] != "Y"):?> disabled<?endif;?>" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.svg" alt="" class="icon"><?=GetMessage("FAST_VIEW_ADDCART_LABEL")?></a>
					<?else:?>
