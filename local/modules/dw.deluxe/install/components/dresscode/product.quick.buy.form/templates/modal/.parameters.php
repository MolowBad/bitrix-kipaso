...
$arTemplateParameters = [
	"USE_PHONE_MASK" => [
		"PARENT" => "BASE",
		"NAME" =>  Loc::getMessage("PQ0_PRODUCT_QUICK_BUY_FORM_MODAL_PARAMETER_USE_PHONE_MASK"),
		"TYPE" => "CHECKBOX",
		"REFRESH" => "Y"
	],
];
...
if(isset($arCurrentValues["USE_PHONE_MASK"]) && $arCurrentValues["USE_PHONE_MASK"] === "Y"){
	$arTemplateParameters["PHONE_MASK_FORMAT"] = [
		"PARENT" => "BASE",
		"NAME" =>  Loc::getMessage("PQ0_PRODUCT_QUICK_BUY_FORM_MODAL_PARAMETER_PHONE_MASK_FORMAT"),
		"TYPE" => "LIST",
		"VALUES" => [
